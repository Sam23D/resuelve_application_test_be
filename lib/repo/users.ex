defmodule Repo.Users do
  ...
  def get_users_for_span( date_start \\ "2017-01-01", date_end \\ "2017-02-01")
  def get_users_for_span( date_start , date_end )  when is_string_date_range( date_start, date_end ) do
